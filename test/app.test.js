...
//     test('If request body is present but the food item does not have a type of an allowed length, server should respond with status code 400 and {"message": "not a valid category"}', (done) => {
//         request(app).post('/food-items').send({
//             name: "milk",
//             category: "S",
//             calories: 100
